---
title: "MIKE analysis for Africa - Technical Report (updated 03-June-2026)"
author: "CITES MIKE"
...
The computer code from the [GIT hub repository](https://github.com/CITESmike2020/MIKE-GLMM) has been modified to estimate yearly PIKE trends from 2003-2025 using only the unweighted marginal mean PIKE model (MM.p.uw), which does not require elephant population abundance data at the site-year level. The pro and cons of this approach are discussed in more detail in the original technical document.  
